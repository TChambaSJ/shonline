...
from .forms import RequisitionForm, ActualExpenseForm, ConfirmPaymentForm, LiquidationForm, ProcessRequisitionForm ,BudgetedExpenseForm, AuthoriseRequisitionForm, RecommendRequisitionForm
...
@login_required(login_url='login')
@allowed_users(allowed_roles=['Head of Department'])
